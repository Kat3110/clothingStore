...
(ChiefSlider.prototype._addEventListener = function () {
  ...
  function r(t) {
    if (this._hasSwipeState) {
      ...
      e > 50
        ...
        : e < -50 && ((this._direction = "prev"), this._move()),
        (this._hasSwipeState = !1),
  ...
  t.addEventListener(
    ...
    function (t) {
      var i = t.target;
      if ((this._autoplay("stop"), i.classList.contains(CONTROL_CLASS)))
    ...
    e.swipe &&
      (t.addEventListener("touchstart", s.bind(this)),
    ...
    if (this._balancingItemsFlag) {
      ...
      if ("next" === this._direction) {
        ...
        (t = this._minTranslate),
          a.getBoundingClientRect().right < r - e &&
            ((a.dataset.order = this._minOrder + s),
            (t += 100 * s),
        ...
        (t = this._maxTranslate),
          o.getBoundingClientRect().left > n + e &&
            ((o.dataset.order = this._maxOrder - s),
            (t -= 100 * s),
  ...
  (ChiefSlider.prototype._setActiveClass = function () {
    for (
      var t = this._activeItems, i = this._$itemList, e = 0, s = i.length;
      e < s;
      e++
    ) {
      var r = i[e],
        a = +r.dataset.index;
      t.indexOf(a) > -1
        ? r.classList.add(CLASS_ITEM_ACTIVE)
        : r.classList.remove(CLASS_ITEM_ACTIVE);
    }
  }),
  (ChiefSlider.prototype._updateIndicators = function () {
    ...
    if (t.length)
      for (var e = 0, s = i.length; e < s; e++) {
        i[e].classList.contains(CLASS_ITEM_ACTIVE)
          ? t[e].classList.add(CLASS_INDICATOR_ACTIVE)
          : t[e].classList.remove(CLASS_INDICATOR_ACTIVE);
      }
  }),
  (ChiefSlider.prototype._move = function () {
    var t =
        "next" === this._direction ? -this._transformStep : this._transformStep,
      i = this._transform + t;
    if (!this._config.loop) {
      var e =
        this._transformStep *
    ...
    var s,
      ...
      o = 0;
    if ("next" === this._direction)
      for (o = 0, s = this._activeItems.length; o < s; o++)
        (r = this._activeItems[o]),
          (a = ++r) > this._$itemList.length - 1 &&
  ...
  (ChiefSlider.prototype._moveTo = function (t) {
    ...
    for (i = 0, e = s.length; i < e; i++) {
      ...
      if (n.classList.contains(CLASS_INDICATOR_ACTIVE)) {
        ...
        null === a
          ? ((r = o), (a = Math.abs(t - r)))
          : Math.abs(t - o) < a && ((r = o), (a = Math.abs(t - r)));
      }
    }
    if (0 !== (a = t - r))
      for (
        this._direction = a > 0 ? "next" : "prev", i = 1;
        i <= Math.abs(a);
        i++
      )
        this._move();
